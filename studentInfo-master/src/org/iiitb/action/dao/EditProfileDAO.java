...
public void setSemester(int semester) {
	...
	try
	{
		ps=con.prepareStatement("update student set current_sem = ? where student_id = ?;");
...
public void setRollno(String rollno) {
	...
	try
	{
		ps=con.prepareStatement("update user set roll_no = ? where user_id = ?");
...
public void setName(String name) {
	...
	try
	{
		ps=con.prepareStatement("update user set name = ? where student_id = ?");
		ps.setString(1, name);
		ps.setString(2, userid);
		int s = ps.executeUpdate();
	}
