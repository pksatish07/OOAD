 ...
 * 
 */
public class ShowNotification extends ActionSupport implements SessionAware
{
	/**
	 * 
	 */
  ...
  public String execute() throws SQLException
	{
		...
		if (user != null)
		{
			...
			NotificationDAO notDao = new NotificationDAOImpl();
			if (studentInfo != null)
			{

				setMyProfile(studentInfo);

				setStudents(notDao.getFriends(user.getUserId()));
