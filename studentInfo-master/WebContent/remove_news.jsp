...
<body>
	...
	<div class="panel panel-default">
		<div class="panel-body" style="background: #D3D3D3;">
			...
			<h2 align="center">Remove News</h2>
							...
							<div class="form-group">
								<div class="form-horizontal">
									<div class="control-group row-fluid form-inline">
											...
											<ul class="dropdown-menu" role="menu">
												<%
													Connection conn = ConnectionPool.getConnection();
														...
														try {
															ps = conn.prepareStatement("Select name from news;");

															rs = ps.executeQuery();
															ResultSet size = conn.prepareStatement(
																	"Select count(*) from news;").executeQuery();
										...
										<input class="btn btn-default btn-lg" type="submit" value="Delete"></input>
									</div>
								</div>
							</div>
						</div>
